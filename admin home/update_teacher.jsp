...

{
    ...
    ResultSet rs=stmt.executeQuery("select * from  teachers where teacher_id='"+sr+"' ");
    while(rs.next())
...
<div class="container min-vh-100 d-flex justify-content-center align-items-center">
    ...
    <div class="col-md-4"><center> <h1 class="h1 text-dark">View Teachers Details</h1></center>
        <div class="contact-form border "> 
            <form action="update_teacher_action.jsp" method="post">
                <div class="form-group">
                    <div class="mb-4 w-20">
                        <label for="exampleFormControlInput1" class="form-label text-dark ">Teacher Id </label>
    ...
    <div class="mb-4 w-20">
        <label for="exampleFormControlInput1" class="form-label text-dark ">Teacher Name </label>
      ...
      <div class="mb-4 w-20">
        <label for="exampleFormControlInput1" class="form-label text-dark">Teacher Email</label>
      ...
      <div class="mb-4 w-20">
        <label for="exampleFormControlInput1" class="form-label text-dark ">Department  </label>
        <input type="text" class="form-control bg-primary" name="t5" value="<%=rs.getString(5) %>" id="exampleFormControlInput1" placeholder="date  ">
      </div>
     
      <div class="mb-4 w-20">
        <label for="exampleFormControlInput1" class="form-label text-dark ">Designation  </label>
