...
<h2 style="margin-top: 5%; margin-bottom: 3%;">Assignment Submissions List</h2>
    ...
    <tbody>
        <%
            ...
            try {
                ...
                // Iterate through the result set and display each submission in a table row
                while (rs.next()) {
        ...
        %>
                    <tr>
                        ...
                        <td>
                            <img src="<%= file_path %>" height="40" width="50" alt="Submission File" style="height: 200px; width: 200px;">
                        </td>
                    </tr>
        <%
                }
